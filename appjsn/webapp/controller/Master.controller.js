sap.ui.define([
	...
	return Controller.extend("appjsn.controller.Master", {
		onInit: function () {
		...
		onListItemPress: function (oEvent) {
			let productPath = oEvent.getSource().getBindingContext("products").getPath();
			let product = productPath.split("/").slice(-1).pop();
