		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#nssplitreuseapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nssplitreuseapp-display": {
								"semanticObject": "nssplitreuseapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.splitreuseapp",
									"url": sap.ui.require.toUrl("ns/splitreuseapp")
								}
							}
						}
					}
