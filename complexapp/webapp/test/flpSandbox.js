		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#nscomplexapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nscomplexapp-display": {
								"semanticObject": "nscomplexapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.complexapp",
									"url": sap.ui.require.toUrl("ns/complexapp")
								}
							}
						}
					}
